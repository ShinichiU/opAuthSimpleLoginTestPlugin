...
/**
 * opAuthAdapterSimpleLoginTest will handle credential for member id.
 *
 * @package    OpenPNE
 * @subpackage user
 * @author     Shinichi Urabe <urabe@tejimaya.com>
 */
class opAuthAdapterSimpleLoginTest extends opAuthAdapter
{
  protected $authModuleName = 'opAuthSimpleLoginTest';
